...
const invoiceTranslations = {
  ...
  flightType: "نوع پرواز  ",
    ...
    documents: "مدارک",
    // Passengers
    passengerInfo: "لیست مسافران / Information Passengers",
...
2: {
  ...
  textAlign: "text-left",
  centerText: "text-center",
  contractTitle: "Travel and Tourism Service Agreement",
  ...
  totalCostTable: "Total Price Table",
  totalCost: "Total Cost",
  commission: "Commission",
  discount: "Discount",
  discountCode: "Discount Code",
  costByCommission: "Payable Amount After Commission",
  unit: "Unit",
  transfertitle: "Transfer Price Table",
  servicetitle: "Service Price Table",
  escorttitle: "Escort Price Table",
  totalpricetitle: "Total Price Table",
  passengerType: "Passenger Age Range",
  escortName: "Escort",
  ...
  passengerPricing: "Price Table by Passengers",
  count: "Count",
  perPerson: "Unit Cost",
  total: "Total",
  ...
  carName: "Car Name",
  contractText: {
    "template": "This agreement is made between Mr./Ms. {buyerName} with phone number {phone} and mobile {mobile}, residing at {address}, either individually or on behalf of the following persons totaling {personCount}, hereinafter referred to as 'the Tourist', and the office {officeName}, hereinafter referred to as 'the Operator', concluded via online purchase."
  }
}
,
3: {
  ...
  textAlign: "text-right",
  centerText: "text-center",
  contractTitle: "عقد تقديم خدمات السفر والسياحة",
  ...
  description: "الوصف",
  totalCostTable: "جدول الأسعار الإجمالية",
  totalCost: "السعر الإجمالي",
  commission: "العمولة",
  discount: "الخصم",
  discountCode: "رمز الخصم",
  costByCommission: "المبلغ المستحق بعد الخصم",
  unit: "الوحدة",
  transfertitle: "جدول أسعار النقل",
  servicetitle: "جدول أسعار الخدمات",
  escorttitle: "جدول أسعار المرافق",
  totalpricetitle: "جدول الأسعار الإجمالية",
  passengerType: "الفئة العمرية للمسافر",
  escortName: "المرافق",
  ...
  validity: "الصلاحية",
  documents: "المستندات",
  passengerInfo: "معلومات المسافرين",
  ...
  costTableByProduct: "جدول التكاليف حسب المنتج",
  flight: "رحلة",
  insurance: "تأمين",
  transfer: "نقل",
  visa: "تأشيرة",
  ...
  passengerPricing: "جدول الأسعار حسب المسافرين",
  count: "العدد",
  perPerson: "سعر الفرد",
  total: "المجموع",
  ...
  carName: "اسم السيارة",
  contractText: {
    "template": "تم توقيع هذا العقد بين السيد/السيدة {buyerName} برقم الهاتف {phone} والجوال {mobile} والمقيم في {address}، بصفة شخصية أو نيابةً عن الأفراد المذكورين أدناه بعدد إجمالي {personCount} شخص، ويُشار إليهم فيما بعد بـ \"السائح\"، ومن جهة أخرى المكتب {officeName} ويُشار إليه بـ \"المزود\"، وقد تم التعاقد عبر الشراء الإلكتروني."
  }
}
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M15.0159 6.43817C15.1333 6.43817 15.2284 6.34303 15.2284 6.22567V6.169C15.2284 4.19063 13.9577 2.86108 12.0664 2.86108H4.93278C3.04223 2.86108 1.77148 4.19063 1.77148 6.169V6.22567C1.77148 6.34303 1.86662 6.43817 1.98398 6.43817H15.0159Z" fill="#292929"/>
  ...
  <div class="mb-4 rounded-[10px] bg-[#F8F8F8] relative py-2 px-6 overflow-hidden">
    <div class="w-full ${t.textAlign}">
      <div class="flex gap-2 mb-2  max-md:flex-col max-md:justify-center max-md:items-center">
      ...
      <div class="flex gap-2  max-md:flex-col max-md:justify-center max-md:items-center">
...
`).join('');
  ...
  <div class="flex gap-2 py-1 max-md:flex-col max-md:justify-center max-md:items-center">
    ${columns.map(col => {
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M8.07369 6.90877C7.89164 7.01006 7.7181 7.13117 7.57856 7.31746C7.46239 7.47259 7.39439 7.64896 7.44327 7.87067C7.47444 8.01092 7.54456 8.11929 7.62814 8.2135C7.80806 8.41679 8.02127 8.54288 8.24227 8.64771C8.64177 8.83754 9.05685 8.94096 9.4776 9.00825C9.83248 9.06492 10.1895 9.09396 10.4771 9.089C11.1486 9.08971 11.7436 9.02242 12.3301 8.84817C12.6226 8.76104 12.9081 8.647 13.1751 8.46779C13.3217 8.36934 13.4591 8.25388 13.5654 8.086C13.7056 7.86358 13.7078 7.60434 13.5647 7.38475C13.5158 7.30967 13.4591 7.24025 13.3982 7.18146C13.1716 6.96118 12.9088 6.83297 12.6396 6.72743C12.1608 6.53972 11.6678 6.44693 11.1691 6.40514C10.4891 6.34777 9.81194 6.37681 9.13902 6.52556C8.77352 6.6056 8.4151 6.71822 8.07369 6.90877Z" fill="#292929"/>
  ...
  <div class="mb-4 rounded-[10px] bg-[#F8F8F8] relative py-2 px-6 overflow-hidden">
    <div class="w-full ${t.textAlign}">
      <div class="flex gap-2 mb-2  max-md:flex-col max-md:justify-center max-md:items-center">
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-[12%] text-center my-1">${t.flight}</div>
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-[12%] text-center my-1">${t.hotel}</div>
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-[12%] text-center my-1">${t.insurance}</div>
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-[12%] text-center my-1">${t.service}:</div>
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-[12%] text-center my-1">${t.transfer}</div>
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-[12%] text-center my-1">${t.visa}:</div>
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-[12%] text-center my-1">${t.totalCost}</div>
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-[12%] text-center my-1">${t.unit}</div>
      </div>
      <div class="flex gap-2  max-md:flex-col max-md:justify-center max-md:items-center">
        <div class="text-[#292929] text-xs w-[12%] text-center my-1 font-danamedium flex-1">${formatPrice(flight)}</div>
        <div class="text-[#292929] text-xs w-[12%] text-center my-1 font-danamedium flex-1">${formatPrice(hotel)}</div>
        <div class="text-[#292929] text-xs w-[12%] text-center my-1 font-danamedium flex-1">${formatPrice(insurance)}</div>
        <div class="text-[#292929] text-xs w-[12%] text-center my-1 font-danamedium flex-1">${formatPrice(service)}</div>
        <div class="text-[#292929] text-xs w-[12%] text-center my-1 font-danamedium flex-1">${formatPrice(transfer)}</div>
        <div class="text-[#292929] text-xs w-[12%] text-center my-1 font-danamedium flex-1">${formatPrice(visa)}</div>
        <div class="text-[#292929] text-xs w-[12%] text-center my-1 font-danamedium flex-1">${formatPrice(total)}</div>
        <div class="text-[#292929] text-xs w-[12%] text-center my-1 font-dana_FANum_medium flex-1">${unit}</div>
      </div>
    </div>
  </div>
</section>
`;
  ...
  switch (type) {
    case '3': { // Hotel Room Price
      ...
      if (Array.isArray(priceDetails.roomPrice)) {
        priceDetails.roomPrice.forEach((item, index) => {
          ...
          guests.forEach(([guestType, guestData]) => {
            ...
            allRowsData.push({
              [t.room]: `${t.room} ${roomIndex}`,
              [t.guestType]: guestType.charAt(0).toUpperCase() + guestType.slice(1),
              [t.count]: count,
      ...
      return `
        ${startSection(t.roomPriceDetails)}
          ${renderMultipleRows(
            [t.room, t.guestType, t.count, t.perPerson, t.total, t.unit], 
            allRowsData
          )}
        ${endSection()}
      `;
    ...
    case '4': { // Tour
      ...
      return `
        ${startSection(t.tourPriceDetails)}
          ${renderMultipleRows(
            [t.room, t.guestType, t.count, t.perPerson, t.total, t.unit], 
            allRowsData
          )}
...
<div class="mb-4 rounded-[10px] bg-[#F8F8F8] relative overflow-hidden" dir="${t.dir}">
  <div class="flex justify-between items-center py-[6px] px-2  max-md:flex-col max-md:justify-center max-md:items-center">
    <div class="flex gap-x-1 items-center">
      <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.lounge} : </span>
    ...
    <div class="flex gap-x-1 items-center">
      <div class="flex justify-between px-2 gap-x-5  max-md:flex-col max-md:justify-center max-md:items-center">
        <div class="flex gap-x-1 items-center">
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.airport} : </span>
          <span class="text-[#292929] text-sm text-nowrap font-danamedium"> ${cip.airportname || '-'}</span>
        </div>
        <div class="flex gap-x-1 items-center">
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.airline} : </span>
          <span class="text-[#292929] text-sm text-nowrap font-danamedium"> ${cip.airline || '-'}</span>
        </div>
        <div class="flex gap-x-1 items-center">
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.flightNo} : </span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M7.42875 5.1765H4.05313C3.86338 5.1765 3.70938 5.0225 3.70938 4.83275C3.70938 4.643 3.86338 4.489 4.05313 4.489H7.42875C7.6185 4.489 7.7725 4.643 7.7725 4.83275C7.7725 5.0225 7.6185 5.1765 7.42875 5.1765ZM7.59971 7.67625L6.65371 8.559C6.58725 8.62087 6.50292 8.65112 6.41904 8.65112C6.32692 8.65112 6.23525 8.61446 6.16788 8.54204C6.03817 8.40316 6.0455 8.18546 6.18438 8.05575L6.49192 7.76883H4.23371C4.04396 7.76883 3.88996 7.61483 3.88996 7.42508C3.88996 7.23533 4.04396 7.08133 4.23371 7.08133H6.49238L6.18483 6.79441C6.0455 6.66516 6.03817 6.44746 6.16742 6.30858C6.29713 6.17016 6.51438 6.16191 6.65325 6.29162L7.59925 7.173C7.66892 7.23808 7.70879 7.32929 7.70879 7.42462C7.70879 7.51996 7.66892 7.61116 7.59971 7.67625ZM9.16583 2.44162C8.83446 2.10933 8.36146 1.92187 7.79909 1.87512V1.43237C7.79909 1.24262 7.64508 1.08862 7.45533 1.08862C7.26558 1.08862 7.11158 1.24262 7.11158 1.43237V3.059C7.08179 3.06771 7.052 3.07779 7.01946 3.07779C6.82971 3.07779 6.67571 2.92379 6.67571 2.73404V1.94662C6.67571 1.896 6.63469 1.85496 6.58404 1.85496H4.46563V1.43237C4.46563 1.24262 4.31163 1.08862 4.12188 1.08862C3.93213 1.08862 3.77813 1.24262 3.77813 1.43237V3.059C3.74833 3.06771 3.71854 3.07779 3.686 3.07779C3.49625 3.07779 3.34225 2.92379 3.34225 2.73404V2.0626C3.34225 2.00298 3.28605 1.9592 3.22897 1.97643C2.35417 2.24048 1.84717 2.95083 1.84717 3.99904V7.73217C1.84717 9.09708 2.6685 9.91154 4.04396 9.91154H7.53325C8.90871 9.91154 9.73004 9.10854 9.73004 7.76379V3.9995C9.73188 3.35233 9.53663 2.81379 9.16583 2.44162Z" fill="#6D6D6D"/>
          ...
          <span class="text-[#6D6D6D] text-xs font-danaregular">${t.date} : </span>
          <span class="text-[#292929] text-sm font-danamedium"> 
        ...
        <div class="flex items-center gap-x-2">
          ...
          <span class="text-[#292929] text-sm font-danamedium"> ${travelTypeMap[cip.travelType] || '-'}</span>
        </div>
        <div class="flex items-center gap-x-2">
          <span class="text-[#6D6D6D] text-xs font-danaregular">${t.flightType} : </span>
          <span class="text-[#292929] text-sm font-danamedium"> ${flightTypeMap[cip.flightType] || '-'}</span>
        </div>
      </div>
    </div>
  </div>
...
<div class="mb-4 rounded-[10px] bg-[#F8F8F8] relative overflow-hidden" dir="${t.dir}">
  <div class="flex justify-between items-center py-[6px] px-2  max-md:flex-col max-md:justify-center max-md:items-center ">
    <div class="flex gap-x-1 items-center">
      <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.hotel}</span>
      <span class="text-[#292929] text-sm text-nowrap font-danamedium">${hotelName}</span>
    </div>
    <div class="flex gap-x-1 items-center">
      <div class="flex justify-between px-2 gap-x-5  max-md:flex-col max-md:justify-center max-md:items-center">
        <div><span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.grade}</span><span class="text-[#292929] text-sm text-nowrap font-danamedium">${hotelStar} star</span></div>
        <div><span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.services}</span><span class="text-[#292929] text-sm text-nowrap font-danamedium">${service}</span></div>
        <div><span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.roomType}</span><span class="text-[#292929] text-sm text-nowrap font-danamedium">${roomType}</span></div>
      </div>
    </div>
  </div>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M5.72936 6.06138C5.03224 6.06138 4.46482 5.49396 4.46482 4.79683C4.46482 4.09971 5.03224 3.53229 5.72936 3.53229C6.42649 3.53229 6.99345 4.09971 6.99345 4.79683C6.99345 5.49396 6.42649 6.06138 5.72936 6.06138ZM5.72936 1.14575C3.70124 1.14575 2.05078 2.79621 2.05078 4.82479C2.05078 7.40796 5.07211 9.85408 5.72936 9.85408C6.38661 9.85408 9.40795 7.40796 9.40795 4.82479C9.40795 2.79621 7.75749 1.14575 5.72936 1.14575Z" fill="#6D6D6D"/>
          ...
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.city}</span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M10.7605 6.03858C10.6537 5.73974 10.4191 5.50278 10.1065 5.38453C9.93186 5.32495 9.75173 5.32495 9.42448 5.32495H3.28647C2.95922 5.32495 2.77864 5.32495 2.59347 5.38866C2.29189 5.50278 2.05768 5.73974 1.95089 6.03674C1.88672 6.21274 1.88672 6.39378 1.88672 6.72287V8.87703C1.88672 9.06679 2.04072 9.22079 2.23047 9.22079C2.42022 9.22079 2.57422 9.06679 2.57422 8.87703V8.74412C2.57422 8.69352 2.61526 8.65245 2.66589 8.65245H10.0451C10.0957 8.65245 10.1367 8.69352 10.1367 8.74412V8.87703C10.1367 9.06679 10.2907 9.22079 10.4805 9.22079C10.6702 9.22079 10.8242 9.06679 10.8242 8.87703V6.72287C10.8242 6.39378 10.8242 6.21274 10.7605 6.03858Z" fill="#6D6D6D"/>
          ...
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.room}</span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M7.12154 6.41675H5.05902C3.91318 6.41675 2.95068 7.37925 2.95068 8.52508V8.66258C2.95068 9.12091 3.31735 9.48758 3.77568 9.48758H8.35904C8.81737 9.48758 9.22987 9.16675 9.18404 8.66258V8.52508C9.22987 7.37925 8.26737 6.41675 7.12154 6.41675Z" fill="#6D6D6D"/>
          ...
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.passengers}</span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M7.42875 5.1765H4.05313C3.86338 5.1765 3.70938 5.0225 3.70938 4.83275C3.70938 4.643 3.86338 4.489 4.05313 4.489H7.42875C7.6185 4.489 7.7725 4.643 7.7725 4.83275C7.7725 5.0225 7.6185 5.1765 7.42875 5.1765ZM7.59971 7.67625L6.65371 8.559C6.58725 8.62087 6.50292 8.65112 6.41904 8.65112C6.32692 8.65112 6.23525 8.61446 6.16788 8.54204C6.03817 8.40316 6.0455 8.18546 6.18438 8.05575L6.49192 7.76883H4.23371C4.04396 7.76883 3.88996 7.61483 3.88996 7.42508C3.88996 7.23533 4.04396 7.08133 4.23371 7.08133H6.49238L6.18483 6.79441C6.0455 6.66516 6.03817 6.44746 6.16742 6.30858C6.29713 6.17016 6.51438 6.16191 6.65325 6.29162L7.59925 7.173C7.66892 7.23808 7.70879 7.32929 7.70879 7.42462C7.70879 7.51996 7.66892 7.61116 7.59971 7.67625ZM9.16583 2.44162C8.83446 2.10933 8.36146 1.92187 7.79909 1.87512V1.43237C7.79909 1.24262 7.64508 1.08862 7.45533 1.08862C7.26558 1.08862 7.11158 1.24262 7.11158 1.43237V3.059C7.08179 3.06771 7.052 3.07779 7.01946 3.07779C6.82971 3.07779 6.67571 2.92379 6.67571 2.73404V1.94662C6.67571 1.896 6.63469 1.85496 6.58404 1.85496H4.46563V1.43237C4.46563 1.24262 4.31163 1.08862 4.12188 1.08862C3.93213 1.08862 3.77813 1.24262 3.77813 1.43237V3.059C3.74833 3.06771 3.71854 3.07779 3.686 3.07779C3.49625 3.07779 3.34225 2.92379 3.34225 2.73404V2.0626C3.34225 2.00298 3.28605 1.9592 3.22897 1.97643C2.35417 2.24048 1.84717 2.95083 1.84717 3.99904V7.73217C1.84717 9.09708 2.6685 9.91154 4.04396 9.91154H7.53325C8.90871 9.91154 9.73004 9.10854 9.73004 7.76379V3.9995C9.73188 3.35233 9.53663 2.81379 9.16583 2.44162Z" fill="#6D6D6D"/>
          ...
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.checkIn}</span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M7.42875 5.1765H4.05313C3.86338 5.1765 3.70938 5.0225 3.70938 4.83275C3.70938 4.643 3.86338 4.489 4.05313 4.489H7.42875C7.6185 4.489 7.7725 4.643 7.7725 4.83275C7.7725 5.0225 7.6185 5.1765 7.42875 5.1765ZM7.59971 7.67625L6.65371 8.559C6.58725 8.62087 6.50292 8.65112 6.41904 8.65112C6.32692 8.65112 6.23525 8.61446 6.16788 8.54204C6.03817 8.40316 6.0455 8.18546 6.18438 8.05575L6.49192 7.76883H4.23371C4.04396 7.76883 3.88996 7.61483 3.88996 7.42508C3.88996 7.23533 4.04396 7.08133 4.23371 7.08133H6.49238L6.18483 6.79441C6.0455 6.66516 6.03817 6.44746 6.16742 6.30858C6.29713 6.17016 6.51438 6.16191 6.65325 6.29162L7.59925 7.173C7.66892 7.23808 7.70879 7.32929 7.70879 7.42462C7.70879 7.51996 7.66892 7.61116 7.59971 7.67625ZM9.16583 2.44162C8.83446 2.10933 8.36146 1.92187 7.79909 1.87512V1.43237C7.79909 1.24262 7.64508 1.08862 7.45533 1.08862C7.26558 1.08862 7.11158 1.24262 7.11158 1.43237V3.059C7.08179 3.06771 7.052 3.07779 7.01946 3.07779C6.82971 3.07779 6.67571 2.92379 6.67571 2.73404V1.94662C6.67571 1.896 6.63469 1.85496 6.58404 1.85496H4.46563V1.43237C4.46563 1.24262 4.31163 1.08862 4.12188 1.08862C3.93213 1.08862 3.77813 1.24262 3.77813 1.43237V3.059C3.74833 3.06771 3.71854 3.07779 3.686 3.07779C3.49625 3.07779 3.34225 2.92379 3.34225 2.73404V2.0626C3.34225 2.00298 3.28605 1.9592 3.22897 1.97643C2.35417 2.24048 1.84717 2.95083 1.84717 3.99904V7.73217C1.84717 9.09708 2.6685 9.91154 4.04396 9.91154H7.53325C8.90871 9.91154 9.73004 9.10854 9.73004 7.76379V3.9995C9.73188 3.35233 9.53663 2.81379 9.16583 2.44162Z" fill="#6D6D6D"/>
          ...
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.checkOut}</span>
  ...
  <div class="mb-4 rounded-[10px] bg-[#F8F8F8] relative overflow-hidden" dir="${t.dir}">
    <div class="flex justify-between items-center py-[6px] px-2 ">
      ...
      <div class="flex gap-x-1 items-center">
        <div class="flex justify-between px-2 gap-x-5  max-md:flex-col max-md:justify-center max-md:items-center">
          <div class="flex gap-x-1 items-center">
            <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.grade}</span>
            <span class="text-[#292929] text-sm text-nowrap font-danamedium">${hotelStar} star</span>
          </div>
          <div class="flex gap-x-1 items-center">
            <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.services}</span>
            <span class="text-[#292929] text-sm text-nowrap font-danamedium">${roomService}</span>
          </div>
          <div class="flex gap-x-1 items-center">
            <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.roomType}</span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M8.17319 6.2289C7.96769 6.2289 7.80119 6.0624 7.80119 5.8569C7.80119 5.6519 7.96769 5.4854 8.17319 5.4854C8.37869 5.4854 8.54519 5.6519 8.54519 5.8569C8.54519 6.0624 8.37869 6.2289 8.17319 6.2289ZM8.17319 8.1029C7.96769 8.1029 7.80119 7.9364 7.80119 7.7309C7.80119 7.5254 7.96769 7.3589 8.17319 7.3589C8.37869 7.3589 8.54519 7.5254 8.54519 7.7309C8.54519 7.9364 8.37869 8.1029 8.17319 8.1029ZM5.99969 6.2289C5.79469 6.2289 5.62819 6.0624 5.62819 5.8569C5.62819 5.6519 5.79469 5.4854 5.99969 5.4854C6.20519 5.4854 6.37169 5.6519 6.37169 5.8569C6.37169 6.0624 6.20519 6.2289 5.99969 6.2289ZM5.99969 8.1029C5.79469 8.1029 5.62819 7.9364 5.62819 7.7309C5.62819 7.5254 5.79469 7.3589 5.99969 7.3589C6.20519 7.3589 6.37169 7.5254 6.37169 7.7309C6.37169 7.9364 6.20519 8.1029 5.99969 8.1029ZM3.8267 6.2289C3.6212 6.2289 3.4547 6.0624 3.4547 5.8569C3.4547 5.6519 3.6212 5.4854 3.8267 5.4854C4.0322 5.4854 4.1987 5.6519 4.1987 5.8569C4.1987 6.0624 4.0322 6.2289 3.8267 6.2289ZM3.8267 8.1029C3.6212 8.1029 3.4547 7.9364 3.4547 7.7309C3.4547 7.5254 3.6212 7.3589 3.8267 7.3589C4.0322 7.3589 4.1987 7.5254 4.1987 7.7309C4.1987 7.9364 4.0322 8.1029 3.8267 8.1029ZM10.0947 2.6649C9.69269 2.2619 9.11969 2.0349 8.43769 1.9779V1.4414C8.43769 1.2114 8.25069 1.0249 8.02069 1.0249C7.79069 1.0249 7.60419 1.2114 7.60419 1.4414V3.4139C7.56769 3.4239 7.53219 3.4364 7.49269 3.4364C7.26219 3.4364 7.07569 3.2494 7.07569 3.0194V2.0534C7.07569 1.99818 7.03094 1.9534 6.97569 1.9534H4.3957V1.4414C4.3957 1.2114 4.2092 1.0249 3.9792 1.0249C3.7487 1.0249 3.5622 1.2114 3.5622 1.4414V3.4139C3.5262 3.4239 3.4902 3.4364 3.4507 3.4364C3.2207 3.4364 3.0337 3.2494 3.0337 3.0194V2.19141C3.0337 2.12638 2.97244 2.07862 2.91008 2.0971C1.84121 2.41381 1.2207 3.27685 1.2207 4.5534V8.3329C1.2207 9.9879 2.2167 10.9754 3.8847 10.9754H8.11519C9.78319 10.9754 10.7792 10.0019 10.7792 8.3709V4.5544C10.7812 3.7694 10.5447 3.1164 10.0947 2.6649Z" fill="#242424"/>
    ...
    <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.duration}</span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M5.72936 6.06138C5.03224 6.06138 4.46482 5.49396 4.46482 4.79683C4.46482 4.09971 5.03224 3.53229 5.72936 3.53229C6.42649 3.53229 6.99345 4.09971 6.99345 4.79683C6.99345 5.49396 6.42649 6.06138 5.72936 6.06138ZM5.72936 1.14575C3.70124 1.14575 2.05078 2.79621 2.05078 4.82479C2.05078 7.40796 5.07211 9.85408 5.72936 9.85408C6.38661 9.85408 9.40795 7.40796 9.40795 4.82479C9.40795 2.79621 7.75749 1.14575 5.72936 1.14575Z" fill="#6D6D6D"/>
          ...
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.country}</span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M7.12154 6.41675H5.05902C3.91318 6.41675 2.95068 7.37925 2.95068 8.52508V8.66258C2.95068 9.12091 3.31735 9.48758 3.77568 9.48758H8.35904C8.81737 9.48758 9.22987 9.16675 9.18404 8.66258V8.52508C9.22987 7.37925 8.26737 6.41675 7.12154 6.41675Z" fill="#6D6D6D"/>
          ...
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.name}</span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M7.42875 5.1765H4.05313C3.86338 5.1765 3.70938 5.0225 3.70938 4.83275C3.70938 4.643 3.86338 4.489 4.05313 4.489H7.42875C7.6185 4.489 7.7725 4.643 7.7725 4.83275C7.7725 5.0225 7.6185 5.1765 7.42875 5.1765ZM7.59971 7.67625L6.65371 8.559C6.58725 8.62087 6.50292 8.65112 6.41904 8.65112C6.32692 8.65112 6.23525 8.61446 6.16788 8.54204C6.03817 8.40316 6.0455 8.18546 6.18438 8.05575L6.49192 7.76883H4.23371C4.04396 7.76883 3.88996 7.61483 3.88996 7.42508C3.88996 7.23533 4.04396 7.08133 4.23371 7.08133H6.49238L6.18483 6.79441C6.0455 6.66516 6.03817 6.44746 6.16742 6.30858C6.29713 6.17016 6.51438 6.16191 6.65325 6.29162L7.59925 7.173C7.66892 7.23808 7.70879 7.32929 7.70879 7.42462C7.70879 7.51996 7.66892 7.61116 7.59971 7.67625ZM9.16583 2.44162C8.83446 2.10933 8.36146 1.92187 7.79909 1.87512V1.43237C7.79909 1.24262 7.64508 1.08862 7.45533 1.08862C7.26558 1.08862 7.11158 1.24262 7.11158 1.43237V3.059C7.08179 3.06771 7.052 3.07779 7.01946 3.07779C6.82971 3.07779 6.67571 2.92379 6.67571 2.73404V1.94662C6.67571 1.896 6.63469 1.85496 6.58404 1.85496H4.46563V1.43237C4.46563 1.24262 4.31163 1.08862 4.12188 1.08862C3.93213 1.08862 3.77813 1.24262 3.77813 1.43237V3.059C3.74833 3.06771 3.71854 3.07779 3.686 3.07779C3.49625 3.07779 3.34225 2.92379 3.34225 2.73404V2.0626C3.34225 2.00298 3.28605 1.9592 3.22897 1.97643C2.35417 2.24048 1.84717 2.95083 1.84717 3.99904V7.73217C1.84717 9.09708 2.6685 9.91154 4.04396 9.91154H7.53325C8.90871 9.91154 9.73004 9.10854 9.73004 7.76379V3.9995C9.73188 3.35233 9.53663 2.81379 9.16583 2.44162Z" fill="#6D6D6D"/>
          ...
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.provider}</span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M2.92934 11.8535C2.43705 11.8535 2.03613 12.2566 2.03613 12.7531C2.03613 13.2447 2.43705 13.6449 2.92934 13.6449C3.42163 13.6449 3.82326 13.2447 3.82326 12.7531C3.82326 12.2566 3.42163 11.8535 2.92934 11.8535Z" fill="#292929"/>
          ...
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.serviceName}</span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M8.17319 6.2289C7.96769 6.2289 7.80119 6.0624 7.80119 5.8569C7.80119 5.6519 7.96769 5.4854 8.17319 5.4854C8.37869 5.4854 8.54519 5.6519 8.54519 5.8569C8.54519 6.0624 8.37869 6.2289 8.17319 6.2289ZM8.17319 8.1029C7.96769 8.1029 7.80119 7.9364 7.80119 7.7309C7.80119 7.5254 7.96769 7.3589 8.17319 7.3589C8.37869 7.3589 8.54519 7.5254 8.54519 7.7309C8.54519 7.9364 8.37869 8.1029 8.17319 8.1029ZM5.99969 6.2289C5.79469 6.2289 5.62819 6.0624 5.62819 5.8569C5.62819 5.6519 5.79469 5.4854 5.99969 5.4854C6.20519 5.4854 6.37169 5.6519 6.37169 5.8569C6.37169 6.0624 6.20519 6.2289 5.99969 6.2289ZM5.99969 8.1029C5.79469 8.1029 5.62819 7.9364 5.62819 7.7309C5.62819 7.5254 5.79469 7.3589 5.99969 7.3589C6.20519 7.3589 6.37169 7.5254 6.37169 7.7309C6.37169 7.9364 6.20519 8.1029 5.99969 8.1029ZM3.8267 6.2289C3.6212 6.2289 3.4547 6.0624 3.4547 5.8569C3.4547 5.6519 3.6212 5.4854 3.8267 5.4854C4.0322 5.4854 4.1987 5.6519 4.1987 5.8569C4.1987 6.0624 4.0322 6.2289 3.8267 6.2289ZM3.8267 8.1029C3.6212 8.1029 3.4547 7.9364 3.4547 7.7309C3.4547 7.5254 3.6212 7.3589 3.8267 7.3589C4.0322 7.3589 4.1987 7.5254 4.1987 7.7309C4.1987 7.9364 4.0322 8.1029 3.8267 8.1029ZM10.0947 2.6649C9.69269 2.2619 9.11969 2.0349 8.43769 1.9779V1.4414C8.43769 1.2114 8.25069 1.0249 8.02069 1.0249C7.79069 1.0249 7.60419 1.2114 7.60419 1.4414V3.4139C7.56769 3.4239 7.53219 3.4364 7.49269 3.4364C7.26219 3.4364 7.07569 3.2494 7.07569 3.0194V2.0534C7.07569 1.99818 7.03094 1.9534 6.97569 1.9534H4.3957V1.4414C4.3957 1.2114 4.2092 1.0249 3.9792 1.0249C3.7487 1.0249 3.5622 1.2114 3.5622 1.4414V3.4139C3.5262 3.4239 3.4902 3.4364 3.4507 3.4364C3.2207 3.4364 3.0337 3.2494 3.0337 3.0194V2.19141C3.0337 2.12638 2.97244 2.07862 2.91008 2.0971C1.84121 2.41381 1.2207 3.27685 1.2207 4.5534V8.3329C1.2207 9.9879 2.2167 10.9754 3.8847 10.9754H8.11519C9.78319 10.9754 10.7792 10.0019 10.7792 8.3709V4.5544C10.7812 3.7694 10.5447 3.1164 10.0947 2.6649Z" fill="#242424"/>
          ...
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mx-1">${t.date}</span>
...
//       html += `
//         <div class="w-full flex gap-x-2 max-md:flex-col max-md:justify-center max-md:items-center ${t.textAlign}">
//           <div class="text-[#292929] text-xs font-danamedium flex-1 w-[12%] my-1 text-center max-md:w-full  ">${info.fullname.firstname}</div>
//           <div class="text-[#292929] text-xs font-danamedium flex-1 w-[12%] my-1 text-center max-md:w-full  ">${info.fullname.lastname}</div>
...
//             }
//           </div>
//           <div class="text-[#292929] text-xs font-danamedium flex-1 w-[12%] my-1 text-center max-md:w-full  ">${info.nationalcode}</div>
//           <div class="text-[#292929] text-xs font-danamedium flex-1 w-[12%] my-1 text-center max-md:w-full  ">${info.passportcode}</div>
//           <div class="text-[#292929] text-xs font-danamedium flex-1 w-[12%] my-1 text-center max-md:w-full  ">${info.passportexpiration}</div>
//           <div class="text-[#292929] text-xs font-danamedium flex-1 w-[12%] my-1 text-center max-md:w-full  ">${genderMap[info.gender]}</div>
//           <div class="text-[#292929] text-xs font-danamedium flex-1 w-[12%] my-1 text-center max-md:w-full  ">${typeMap[info.type]}</div>
//         </div>
//       `;
...
//               <div class="w-full flex gap-x-2 max-md:flex-col max-md:justify-center max-md:items-center ${t.textAlign}">
//                 <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-[12%] my-1 text-center max-md:w-full ">${t.firstName}</div>
//                 <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-[12%] my-1 text-center max-md:w-full ">${t.surname}</div>
//                 <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-[12%] my-1 text-center max-md:w-full ">${t.dateOfBirth}</div>
//                 <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-[12%] my-1 text-center max-md:w-full ">${t.nationalCode}</div>
//                 <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-[12%] my-1 text-center max-md:w-full ">${t.passportNo}</div>
//                 <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-[12%] my-1 text-center max-md:w-full ">${t.passportExpiryDate}</div>
//                 <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-[12%] my-1 text-center max-md:w-full ">${t.gender}</div>
//                 <div class="text-[#080000] text-xs font-danaregular flex-1 w-[12%] my-1 text-center ">${t.ageRange}</div>
//               </div>
//             </div>
//             <div class="w-full">
//     `;
...
//           <div class="text-[#292929] text-xs font-danamedium flex-1 w-[12%] my-1 text-center max-md:w-full  ">${info.fullname.firstname}</div>
//           <div class="text-[#292929] text-xs font-danamedium flex-1 w-[12%] my-1 text-center max-md:w-full  ">${info.fullname.lastname}</div>
//           <div class="text-[#292929] text-xs font-danamedium flex-1 w-[12%] my-1 text-center max-md:w-full  ">${info.birthdate?.S_birthdate ?? ""} ${info.birthdate?.M_birthdate ?? ""}</div>
//           <div class="text-[#292929] text-xs font-danamedium flex-1 w-[12%] my-1 text-center max-md:w-full  ">${info.nationalcode}</div>
//           <div class="text-[#292929] text-xs font-danamedium flex-1 w-[12%] my-1 text-center max-md:w-full  ">${info.passportcode}</div>
//           <div class="text-[#292929] text-xs font-danamedium flex-1 w-[12%] my-1 text-center max-md:w-full  ">${info.passportexpiration}</div>
//           <div class="text-[#292929] text-xs font-danamedium flex-1 w-[12%] my-1 text-center max-md:w-full  ">${genderMap[info.gender]}</div>
  ...
  function renderPassengerColumns(passengerList, title = null) {
    ...
    let sectionHtml = `
      <section class="dir-${t.dir} mt-4">
        ...
        ` : ''}
        <div class="bg-[#F8F8F8] rounded-[10px] p-4 flex justify-between gap-2 max-md:flex-col max-md:flex-wrap max-md:justify-center overflow-x-auto" dir="${t.dir}">
