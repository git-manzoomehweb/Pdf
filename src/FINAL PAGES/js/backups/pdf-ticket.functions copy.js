...
for (var i = 0; i < data.length; i++) {
  output += `<div class=" relative "><div class="ticketContainer__details__path__item pathItem flex gap-2 relative mt-1 min-h-[70px]">
...
<g id="SVGRepo_iconCarrier"> <path d="M188,24H68A32.03667,32.03667,0,0,0,36,56V184a32.03667,32.03667,0,0,0,32,32H79.99976L65.59961,235.2002a8.00019,8.00019,0,0,0,12.80078,9.5996L100.00024,216h55.99952l21.59985,28.7998a8.00019,8.00019,0,0,0,12.80078-9.5996L176.00024,216H188a32.03667,32.03667,0,0,0,32-32V56A32.03667,32.03667,0,0,0,188,24ZM84,184a12,12,0,1,1,12-12A12,12,0,0,1,84,184Zm36-64H52V80h68Zm52,64a12,12,0,1,1,12-12A12,12,0,0,1,172,184Zm32-64H136V80h68Z"/> </g>
    ...
    data[i].route.startairport.startotherinfo.shortname
                        ...
                        <div
                        class="pathItem__details__airline flex items-center gap-2 text-xs text-gray-500 absolute top-16 bottom-auto my-auto ">
                        ...
                        <span class="flex gap-1 items-center">
                            ...
                            <span>${data[i].route.baggage.CheckedBag} ${data[i].route.baggage.CabinBag}</span>
                        </span>
                    </div>
                    </div>
                </div>
              <div class="ticketContainer__details__path__item pathItem flex gap-2 relative mt-1 min-h-[70px]">
    ...
    data[i].route.endairport.endotherinfo.shortname
                        ...
                        <div
                        class="hidden pathItem__details__airline flex items-center gap-2 text-xs text-gray-500 mt-1 absolute top-16 bottom-auto my-auto ">
                        <span class="flex gap-1 items-center">
                            <img class="mr-2.5" src="/${
                              data[i].route.trainimage
    ...
    data[i].route.trainid
            ...
            `;
                ...
                for (var i = 0; i < data.length; i++) {
                    output += `<div class=" relative ${(connection_time(data) && (i == 0 || i != data.length-1) ) ? 'mb-0' : 'mb-5'} "><div class="ticketContainer__details__path__item pathItem flex gap-2 relative mt-1 min-h-[70px]">
    ...
    <img class="max-w-none absolute right-0 z-10 ${(connection_time(data) && i == 0) ? '' : 'hidden'}" src="/images/airplane-route.png" width="17" height="23" alt="airplane-route"/>
                    ...
                    <div class="ticketContainer__details__path__item__details pathItem__details w-4/6 pl-2.5">
                        ...
                        <div
                        class="pathItem__details__airline flex items-center gap-2 text-xs text-gray-500 mt-1 absolute top-16 bottom-auto my-auto ">
                        <span class="flex gap-1 items-center">
