...
const invoiceTranslations = {
  1: {
    ...
    // Bill Section
    totalCostTable: "جدول هزینه کل",
    totalCost: "هزینه کل :",
    commission: "کمیسیون :",
    discount: "تخفیف :",
    discountCode: "کد تخفیف:",
    costByCommission: "هزینه با کمیسیون :",
    unit: "واحد:",
    // Flight
    from: "از:",
    to: "به:",
    ...
    // Train
    departureTrain: "قطار رفت",
    returnTrain: "قطار برگشت",
    routeCode: "کد مسیر :",
    trainName: "نام قطار:",
    class: "کلاس:",
    // Insurance
    ...
    passportExpiry: "انقضای پاسپورت",
    issueCountry: "کشور صدور",
    gender: "جنسیت",
    ageType: "نوع سنی",
    cost: "هزینه",
    ...
    ageRange: "محدوده سنی:",
    // Price details
    costTableByProduct: "جدول هزینه بر اساس محصول",
    flight: "پرواز :",
    insurance: "بیمه :",
    transfer: "ترانسفر :",
    visa: "ویزا :",
    ...
    adultLoungeInfo: "اطلاعات لانژ بزرگسال",
    count: "تعداد",
    ...
    // Contract text
    contractText: {
      start: "این قرارداد فی‌مابین خانم/آقای",
      phoneText: "دارای شماره تلفن ثابت",
      mobileText: "و همراه",
      addressText: "به نشانی",
      representativeText: "منعقد یا به نمایندگی تام‌الاختیار از سوی افراد ذیل جمعاً به تعداد",
      personCount: "نفر که از این پس \"گردشگر\" نامیده می‌شوند از یک طرف و دفتر",
      officeText: "که از این پس \"کارگزار\" نامیده می‌شود، به صورت خرید اینترنتی منعقد گردیده است."
    }
  },
  2: {
    // انگلیسی
    ...
    centerText: "text-center",
    // Invoice Details
    contractTitle: "Travel and Tourism Services Contract",
    contractNumber: "Contract Number",
    ...
    costByCommission: "Cost by Commission:",
    unit: "Unit:",
    // Flight
    from: "From:",
    to: "To:",
    ...
    departureFlight: "Departure Flights",
    ...
    // Train
    departureTrain: "Departure Train",
    ...
    ageRange: "Age Range:",
    // Price details
    costTableByProduct: "Cost Table By Product",
    flight: "Flight:",
    insurance: "Insurance:",
    transfer: "Transfer:",
    visa: "Visa:",
    ...
    adultLoungeInfo: "Adult Lounge Info",
    count: "Count",
    ...
    // Contract text
    contractText: {
      start: "This contract is concluded between Mr./Ms.",
      phoneText: "with landline number",
      mobileText: "and mobile number",
      addressText: "residing at",
      representativeText: "either personally or as the authorized representative of the individuals listed below, totaling",
      personCount: "persons (hereinafter referred to as \"Tourist\"), on the one hand, and the office of",
      officeText: "(hereinafter referred to as \"Operator\"), on the other hand, through an online purchase."
    }
  },
  3: {
    // عربی
    ...
    // Bill Section
    totalCostTable: "جدول التكلفة الإجمالية",
    totalCost: "التكلفة الإجمالية:",
    commission: "العمولة:",
    discount: "الخصم:",
    discountCode: "رمز الخصم:",
    costByCommission: "التكلفة بالعمولة:",
    unit: "الوحدة:",
    // Flight
    from: "من:",
    to: "إلى:",
    ...
    flightClass: "درجة الرحلة:",
    departureFlight: "رحلات المغادرة",
    ...
    // Train
    departureTrain: "قطار المغادرة",
    returnTrain: "قطار العودة",
    ...
    adultTicketInfo: "معلومات تذكرة البالغين",
    adultLoungeInfo: "معلومات صالة البالغين",
    count: "العدد",
    ...
    // Contract text
    contractText: {
      start: "هذا العقد مبرم بين السيد/السيدة",
      phoneText: "رقم الهاتف الثابت",
      mobileText: "والجوال",
      addressText: "المقيم في",
      representativeText: "إما شخصياً أو كممثل مفوض من قبل الأفراد المدرجين أدناه، بإجمالي",
      personCount: "أشخاص (يُشار إليهم فيما بعد بـ \"السائح\")، من جهة ومكتب",
      officeText: "(يُشار إليه فيما بعد بـ \"المشغل\")، من جهة أخرى، من خلال شراء عبر الإنترنت."
    }
  }
};
  ...
  <div class="mb-4 rounded-[10px] bg-[#F8F8F8] relative py-2 px-6 overflow-hidden">
    <div class="w-full ${t.textAlign}">
      <div class="flex gap-2 mb-2">
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-1/6 items-center justify-center">${t.totalCost}</div>
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-1/6 items-center justify-center">${t.commission}</div>
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-1/6 items-center justify-center">${t.discount}</div>
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-1/6 items-center justify-center">${t.discountCode}</div>
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-1/6 items-center justify-center">${t.costByCommission}</div>
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-1/6 items-center justify-center">${t.unit}</div>
      </div>
      <div class="flex gap-2">
        <div class="text-[#292929] text-xs font-danamedium flex-1 w-1/6 items-center justify-center">${formatPrice(totalprice)}</div>
        <div class="text-[#292929] text-xs font-danamedium flex-1 w-1/6 items-center justify-center">${formatPrice(commission)}</div>
        <div class="text-[#292929] text-xs font-danamedium flex-1 w-1/6 items-center justify-center">${formatPrice(couponcost)}</div>
        <div class="text-[#292929] text-xs font-danamedium flex-1 w-1/6 items-center justify-center">${safeValue(couponcode)}</div>
        <div class="text-[#292929] text-xs font-danamedium flex-1 w-1/6 items-center justify-center">${formatPrice(totalwithcommisions)}</div>
        <div class="text-[#292929] text-xs font-dana_FANum_medium flex-1 w-1/6 items-center justify-center">${safeValue(unit)}</div>
      </div>
    </div>
  </div>
</section>
...
function renderPriceDetailsSection($data, priceDetails = {}, lid = 1) {
  ...
  const renderMultiRowDiv = (columns = []) => {
    const headers = columns.map(col => `
  <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${col.label}</div>
`).join('');

    const values = columns.map(col => `
  <div class="text-[#292929] text-xs font-danamedium flex-1">
    ${col.label === t.unit ? col.value : formatPrice(col.value)}
  </div>
`).join('');

    return `
  <div class="w-full ${t.textAlign}">
    <div class="flex gap-2 mb-2">${headers}</div>
    <div class="flex gap-2">${values}</div>
  </div>
`;
  };
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M8.07369 6.90877C7.89164 7.01006 7.7181 7.13117 7.57856 7.31746C7.46239 7.47259 7.39439 7.64896 7.44327 7.87067C7.47444 8.01092 7.54456 8.11929 7.62814 8.2135C7.80806 8.41679 8.02127 8.54288 8.24227 8.64771C8.64177 8.83754 9.05685 8.94096 9.4776 9.00825C9.83248 9.06492 10.1895 9.09396 10.4771 9.089C11.1486 9.08971 11.7436 9.02242 12.3301 8.84817C12.6226 8.76104 12.9081 8.647 13.1751 8.46779C13.3217 8.36934 13.4591 8.25388 13.5654 8.086C13.7056 7.86358 13.7078 7.60434 13.5647 7.38475C13.5158 7.30967 13.4591 7.24025 13.3982 7.18146C13.1716 6.96118 12.9088 6.83297 12.6396 6.72743C12.1608 6.53972 11.6678 6.44693 11.1691 6.40514C10.4891 6.34777 9.81194 6.37681 9.13902 6.52556C8.77352 6.6056 8.4151 6.71822 8.07369 6.90877Z" fill="#292929"/>
  ...
  <div class="mb-4 rounded-[10px] bg-[#F8F8F8] relative py-2 px-6 overflow-hidden">
    <div class="w-full ${t.textAlign}">
      <div class="flex gap-2 mb-2">
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.flight}</div>
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.hotel}</div>
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.insurance}</div>
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.service}:</div>
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.transfer}:</div>
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.visa}:</div>
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.totalCost}</div>
        <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.unit}</div>
      </div>
      <div class="flex gap-2">
        <div class="text-[#292929] text-xs font-danamedium flex-1">${formatPrice(flight)}</div>
        <div class="text-[#292929] text-xs font-danamedium flex-1">${formatPrice(hotel)}</div>
        <div class="text-[#292929] text-xs font-danamedium flex-1">${formatPrice(insurance)}</div>
        <div class="text-[#292929] text-xs font-danamedium flex-1">${formatPrice(service)}</div>
        <div class="text-[#292929] text-xs font-danamedium flex-1">${formatPrice(transfer)}</div>
        <div class="text-[#292929] text-xs font-danamedium flex-1">${formatPrice(visa)}</div>
        <div class="text-[#292929] text-xs font-danamedium flex-1">${formatPrice(total)}</div>
        <div class="text-[#292929] text-xs font-dana_FANum_medium flex-1">${unit}</div>
      </div>
    </div>
  </div>
</section>
      ...
      if (Array.isArray(priceDetails.roomPrice)) {
        priceDetails.roomPrice.forEach((item, index) => {
          ...
          guests.forEach(([guestType, guestData]) => {
            ...
            parts.push(`
          ${startSection(`${t.room} ${roomIndex} - ${guestType.charAt(0).toUpperCase() + guestType.slice(1)}`)}
            ${renderMultiRowDiv([
              { label: t.count, value: count },
              { label: t.perPerson, value: perperson },
    ...
    case '11': { // Lounge
      ...
      if (priceDetails.adult?.length) {
        priceDetails.adult.forEach(item => {
          ...
          parts.push(`
            ${startSection(t.adultLoungeInfo)}
              ${renderMultiRowDiv([
                { label: t.count, value: count },
                { label: t.perPerson, value: perperson },
                { label: t.total, value: total },
      ...
      if (priceDetails.transfers?.length) {
        priceDetails.transfers.forEach(item => {
          ...
          parts.push(`
            ${startSection(`${t.transfer}: ${car_name}`)}
              ${renderMultiRowDiv([
                { label: t.perPerson, value: perperson },
                { label: t.total, value: total },
                { label: t.unit, value: unit }
      ...
      if (priceDetails.escortinfo?.length) {
        priceDetails.escortinfo.forEach(item => {
          ...
          parts.push(`
            ${startSection(`${t.escortInfo} ${firsname} ${lastname}`)}
              ${renderMultiRowDiv([
                { label: t.perPerson, value: perperson },
                { label: t.total, value: total },
                { label: t.unit, value: unit }
    ...
    default: { // train-1
      ...
      if (priceDetails.adult?.length) {
        priceDetails.adult.forEach((item, index) => {
          ...
          parts.push(`
            ${startSection(`${t.adultTicketInfo} ${index + 1}`)}
              <div class="w-full ${t.textAlign}">
                <div class="flex gap-2 mb-2">
                  <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-1/5 justify-center items-center">${t.class}</div>
                  <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-1/5 justify-center items-center">${t.count}</div>
                  <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-1/5 justify-center items-center">${t.perPerson}</div>
                  <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-1/5 justify-center items-center">${t.total}</div>
                  <div class="text-[#6D6D6D] text-xs font-danaregular flex-1 w-1/5 justify-center items-center">${t.unit}</div>
                </div>
                <div class="flex gap-2">
                  <div class="text-[#292929] text-xs font-danamedium flex-1 w-1/5 justify-center items-center">${special_class}</div>
                  <div class="text-[#292929] text-xs font-danamedium flex-1 w-1/5 justify-center items-center">${formatPrice(count)}</div>
                  <div class="text-[#292929] text-xs font-danamedium flex-1 w-1/5 justify-center items-center">${formatPrice(perperson)}</div>
                  <div class="text-[#292929] text-xs font-danamedium flex-1 w-1/5 justify-center items-center">${formatPrice(total)}</div>
                  <div class="text-[#292929] text-xs font-dana_FANum_medium flex-1 w-1/5 justify-center items-center">${unit}</div>
                </div>
              </div>
            ${endSection()}
          `);
...
function renderInvoiceDetails($data, lid = 1) {
  ...
  return `
    ...
    <div class="w-full flex justify-between flex-wrap gap-y-2" dir="${t.dir}">
        <div class="w-[25.5%] bg-[#F4F4F4] border-2 border-[#E8E8E8] rounded-xl p-4 text-justify">
            <ul class="text-[#414141] font-dana_FANum_regular flex flex-col justify-between gap-y-3">
                ...
                <li class="text-sm"><span>${t.registerDate}</span><span class="inline-block dir-ltr font-dana_FANum_demibold" >${registerDate}</span></li>
                <li class="text-sm"><span>${t.registerTime}</span><span class="font-dana_FANum_demibold" >${registerTime}</span></li>
                <li class="text-sm"><span>${t.counterName}</span><span class="font-dana_FANum_demibold" >${counterName}</span></li>
            </ul>
        </div>
        ...
        <div class="w-[36.5%] bg-[#F4F4F4] border-2 border-[#E8E8E8] rounded-xl p-4 text-justify">
            <ul class="text-[#414141] font-dana_FANum_regular flex flex-col gap-y-[6px]">
                <li class="text-sm"><span>${t.buyerName}</span><span class="font-dana_FANum_demibold" >${buyerName}</span></li>
                <li class="text-sm"><span>${t.address}</span><span class="font-dana_FANum_demibold" >${address}</span></li>
                <li class="text-sm"><span>${t.phone}</span><span class="inline-block dir-ltr font-dana_FANum_demibold">${phone}</span></li>
                <li class="text-sm"><span>${t.email}</span><span class="font-dana_FANum_demibold" >${email}</span></li>
                <li class="text-sm"><span>${t.mobile}</span><span class="inline-block dir-ltr font-dana_FANum_demibold">${mobile}</span></li>
            </ul>
        </div>

        <div class="w-[36.5%] bg-[#F4F4F4] border-2 border-[#E8E8E8] rounded-xl p-4 text-justify">
            <ul class="text-[#414141] font-dana_FANum_regular flex flex-col gap-y-[6px]">
                <li class="text-sm"><span>${t.serviceType}</span><span class="font-dana_FANum_demibold" >${serviceType}</span></li>
            </ul>
        </div>

        <div class="w-full bg-[#F4F4F4] border-2 border-[#E8E8E8] rounded-sm font-danaregular p-4 text-justify" dir="${t.dir}">
          ${contractTextContent}
        </div>
    </div>
`;
...
function renderFlightInfoSection(route, lid = 1) {
  ...
  return `
<div class="mb-4 rounded-[10px] bg-[#F8F8F8] relative pb-[25px] overflow-hidden" dir="${t.dir}">
...
<path d="M16.9708 18H7.02922C6.88886 18 6.75427 17.9473 6.65502 17.8535C6.55577 17.7598 6.5 17.6326 6.5 17.5C6.5 17.3674 6.55577 17.2402 6.65502 17.1465C6.75427 17.0527 6.88886 17 7.02922 17H16.9708C17.1111 17 17.2458 17.0527 17.345 17.1465C17.4443 17.2402 17.5 17.3674 17.5 17.5C17.5 17.6326 17.4443 17.7598 17.345 17.8535C17.2458 17.9473 17.1111 18 16.9708 18Z" fill="#7D7D7D"/>
      ...
      <div>
        <span class="block text-[#6D6D6D] text-xs font-interregular">${t.from}</span>
...
<path d="M16.9708 18H7.02922C6.88886 18 6.75427 17.9473 6.65502 17.8535C6.55577 17.7598 6.5 17.6326 6.5 17.5C6.5 17.3674 6.55577 17.2402 6.65502 17.1465C6.75427 17.0527 6.88886 17 7.02922 17H16.9708C17.1111 17 17.2458 17.0527 17.345 17.1465C17.4443 17.2402 17.5 17.3674 17.5 17.5C17.5 17.6326 17.4443 17.7598 17.345 17.8535C17.2458 17.9473 17.1111 18 16.9708 18Z" fill="#7D7D7D"/>
      ...
      <div>
        <span class="block text-[#6D6D6D] text-xs font-interregular">${t.to}</span>
  ...
  <div class="h-[25px] w-full bg-[#EAEAEA] absolute bottom-0 left-0 right-0 rounded-[4px]">
    <div class="flex justify-between px-2 ${t.textAlign}">
      <div>
...
<div class="mb-4 rounded-[10px] bg-[#F8F8F8] relative overflow-hidden" dir="${t.dir}">
  <div class="flex justify-between items-center py-[6px] px-2">
    <div class="w-1/2 flex gap-x-2 items-center">
      <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mr-1">${t.lounge}</span>
      <span class="text-[#292929] text-sm text-nowrap font-danamedium">${cip.loungename || '-'}</span>
    </div>
    <div class="w-1/2 flex gap-x-2 items-center">
      <div class="flex justify-between px-2 gap-x-5">
        <div>
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mr-1">${t.airport}</span>
          <span class="text-[#292929] text-sm text-nowrap font-danamedium">${cip.airportname || '-'}</span>
        </div>
        <div>
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mr-1">${t.airline}</span>
          <span class="text-[#292929] text-sm text-nowrap font-danamedium">${cip.airline || '-'}</span>
        </div>
        <div>
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mr-1">${t.flightNo}</span>
...
<div class="mb-4 rounded-[10px] bg-[#F8F8F8] relative overflow-hidden" dir="${t.dir}">
  <div class="flex justify-between items-center py-[6px] px-2 ">
    <div class="w-1/2 flex gap-x-2 items-center">
      <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mr-1">${t.hotel}</span>
      <span class="text-[#292929] text-sm text-nowrap font-danamedium">${hotelName}</span>
    </div>
    <div class="w-1/2 flex gap-x-2 items-center">
      <div class="flex justify-between px-2 gap-x-5">
        <div><span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mr-1">${t.grade}</span><span class="text-[#292929] text-sm text-nowrap font-danamedium">${hotelStar} star</span></div>
        <div><span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mr-1">${t.services}</span><span class="text-[#292929] text-sm text-nowrap font-danamedium">${service}</span></div>
        <div><span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mr-1">${t.roomType}</span><span class="text-[#292929] text-sm text-nowrap font-danamedium">${roomType}</span></div>
      </div>
    </div>
  </div>
  <hr class="w-[98%] mx-auto" />
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M5.72936 6.06138C5.03224 6.06138 4.46482 5.49396 4.46482 4.79683C4.46482 4.09971 5.03224 3.53229 5.72936 3.53229C6.42649 3.53229 6.99345 4.09971 6.99345 4.79683C6.99345 5.49396 6.42649 6.06138 5.72936 6.06138ZM5.72936 1.14575C3.70124 1.14575 2.05078 2.79621 2.05078 4.82479C2.05078 7.40796 5.07211 9.85408 5.72936 9.85408C6.38661 9.85408 9.40795 7.40796 9.40795 4.82479C9.40795 2.79621 7.75749 1.14575 5.72936 1.14575Z" fill="#6D6D6D"/>
          ...
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mr-1">${t.city}</span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M10.7605 6.03858C10.6537 5.73974 10.4191 5.50278 10.1065 5.38453C9.93186 5.32495 9.75173 5.32495 9.42448 5.32495H3.28647C2.95922 5.32495 2.77864 5.32495 2.59347 5.38866C2.29189 5.50278 2.05768 5.73974 1.95089 6.03674C1.88672 6.21274 1.88672 6.39378 1.88672 6.72287V8.87703C1.88672 9.06679 2.04072 9.22079 2.23047 9.22079C2.42022 9.22079 2.57422 9.06679 2.57422 8.87703V8.74412C2.57422 8.69352 2.61526 8.65245 2.66589 8.65245H10.0451C10.0957 8.65245 10.1367 8.69352 10.1367 8.74412V8.87703C10.1367 9.06679 10.2907 9.22079 10.4805 9.22079C10.6702 9.22079 10.8242 9.06679 10.8242 8.87703V6.72287C10.8242 6.39378 10.8242 6.21274 10.7605 6.03858Z" fill="#6D6D6D"/>
          ...
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mr-1">${t.room}</span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M7.12154 6.41675H5.05902C3.91318 6.41675 2.95068 7.37925 2.95068 8.52508V8.66258C2.95068 9.12091 3.31735 9.48758 3.77568 9.48758H8.35904C8.81737 9.48758 9.22987 9.16675 9.18404 8.66258V8.52508C9.22987 7.37925 8.26737 6.41675 7.12154 6.41675Z" fill="#6D6D6D"/>
          ...
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mr-1">${t.passengers}</span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="
946 3.07779C6.82971 3.07779 6.67571 2.92379 6.67571 2.73404V1.94662C6.67571 1.896 6.63469 1.85496 6.58404 1.85496H4.46563V1.43237C4.46563 1.24262 4.31163 1.08862 4.12188 1.08862C3.93213 1.08862 3.77813 1.24262 3.77813 1.43237V3.059C3.74833 3.06771 3.71854 3.07779 3.686 3.07779C3.49625 3.07779 3.34225 2.92379 3.34225 2.73404V2.0626C3.34225 2.00298 3.28605 1.9592 3.22897 1.97643C2.35417 2.24048 1.84717 2.95083 1.84717 3.99904V7.73217C1.84717 9.09708 2.6685 9.91154 4.04396 9.91154H7.53325C8.90871 9.91154 9.73004 9.10854 9.73004 7.76379V3.9995C9.73188 3.35233 9.53663 2.81379 9.16583 2.44162Z" fill="#6D6D6D"/>
          ...
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mr-1">${t.checkOut}</span>
  ...
  <div class="mb-4 rounded-[10px] bg-[#F8F8F8] relative overflow-hidden" dir="${t.dir}">
    <div class="flex justify-between items-center py-[6px] px-2 ">
      ...
      <div class="w-1/2 flex gap-x-2 items-center">
        <div class="flex justify-between px-2 gap-x-5">
          <div>
            <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mr-1">${t.grade}</span>
            <span class="text-[#292929] text-sm text-nowrap font-danamedium">${hotelStar} star</span>
          </div>
          <div>
            <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mr-1">${t.services}</span>
            <span class="text-[#292929] text-sm text-nowrap font-danamedium">${roomService}</span>
          </div>
          <div>
            <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mr-1">${t.roomType}</span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M8.17319 6.2289C7.96769 6.2289 7.80119 6.0624 7.80119 5.8569C7.80119 5.6519 7.96769 5.4854 8.17319 5.4854C8.37869 5.4854 8.54519 5.6519 8.54519 5.8569C8.54519 6.0624 8.37869 6.2289 8.17319 6.2289ZM8.17319 8.1029C7.96769 8.1029 7.80119 7.9364 7.80119 7.7309C7.80119 7.5254 7.96769 7.3589 8.17319 7.3589C8.37869 7.3589 8.54519 7.5254 8.54519 7.7309C8.54519 7.9364 8.37869 8.1029 8.17319 8.1029ZM5.99969 6.2289C5.79469 6.2289 5.62819 6.0624 5.62819 5.8569C5.62819 5.6519 5.79469 5.4854 5.99969 5.4854C6.20519 5.4854 6.37169 5.6519 6.37169 5.8569C6.37169 6.0624 6.20519 6.2289 5.99969 6.2289ZM5.99969 8.1029C5.79469 8.1029 5.62819 7.9364 5.62819 7.7309C5.62819 7.5254 5.79469 7.3589 5.99969 7.3589C6.20519 7.3589 6.37169 7.5254 6.37169 7.7309C6.37169 7.9364 6.20519 8.1029 5.99969 8.1029ZM3.8267 6.2289C3.6212 6.2289 3.4547 6.0624 3.4547 5.8569C3.4547 5.6519 3.6212 5.4854 3.8267 5.4854C4.0322 5.4854 4.1987 5.6519 4.1987 5.8569C4.1987 6.0624 4.0322 6.2289 3.8267 6.2289ZM3.8267 8.1029C3.6212 8.1029 3.4547 7.9364 3.4547 7.7309C3.4547 7.5254 3.6212 7.3589 3.8267 7.3589C4.0322 7.3589 4.1987 7.5254 4.1987 7.7309C4.1987 7.9364 4.0322 8.1029 3.8267 8.1029ZM10.0947 2.6649C9.69269 2.2619 9.11969 2.0349 8.43769 1.9779V1.4414C8.43769 1.2114 8.25069 1.0249 8.02069 1.0249C7.79069 1.0249 7.60419 1.2114 7.60419 1.4414V3.4139C7.56769 3.4239 7.53219 3.4364 7.49269 3.4364C7.26219 3.4364 7.07569 3.2494 7.07569 3.0194V2.0534C7.07569 1.99818 7.03094 1.9534 6.97569 1.9534H4.3957V1.4414C4.3957 1.2114 4.2092 1.0249 3.9792 1.0249C3.7487 1.0249 3.5622 1.2114 3.5622 1.4414V3.4139C3.5262 3.4239 3.4902 3.4364 3.4507 3.4364C3.2207 3.4364 3.0337 3.2494 3.0337 3.0194V2.19141C3.0337 2.12638 2.97244 2.07862 2.91008 2.0971C1.84121 2.41381 1.2207 3.27685 1.2207 4.5534V8.3329C1.2207 9.9879 2.2167 10.9754 3.8847 10.9754H8.11519C9.78319 10.9754 10.7792 10.0019 10.7792 8.3709V4.5544C10.7812 3.7694 10.5447 3.1164 10.0947 2.6649Z" fill="#242424"/>
    ...
    <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mr-1">${t.duration}</span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M5.72936 6.06138C5.03224 6.06138 4.46482 5.49396 4.46482 4.79683C4.46482 4.09971 5.03224 3.53229 5.72936 3.53229C6.42649 3.53229 6.99345 4.09971 6.99345 4.79683C6.99345 5.49396 6.42649 6.06138 5.72936 6.06138ZM5.72936 1.14575C3.70124 1.14575 2.05078 2.79621 2.05078 4.82479C2.05078 7.40796 5.07211 9.85408 5.72936 9.85408C6.38661 9.85408 9.40795 7.40796 9.40795 4.82479C9.40795 2.79621 7.75749 1.14575 5.72936 1.14575Z" fill="#6D6D6D"/>
          ...
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mr-1">${t.country}</span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M7.12154 6.41675H5.05902C3.91318 6.41675 2.95068 7.37925 2.95068 8.52508V8.66258C2.95068 9.12091 3.31735 9.48758 3.77568 9.48758H8.35904C8.81737 9.48758 9.22987 9.16675 9.18404 8.66258V8.52508C9.22987 7.37925 8.26737 6.41675 7.12154 6.41675Z" fill="#6D6D6D"/>
          ...
          <span class="text-[#6D6D6D] text-xs text-nowrap font-danaregular mr-1">${t.name}</span>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M7.42875 5.1765H4.05313C3.86338 5.1765 3.70938 5.0225 3.70938 4.83275C3.70938 4.643 3.86338 4.489 4.05313 4.489H7.42875C7.6185 4.489 7.7725 4.643 7.7725 4.83275C7.7725 5.0225 7.6185 5.1765 7.42875 5.1765ZM7.59971 7.67625L6.65371 8.559C6.58725 8.62087 6.50292 8.65112 6.41904 8.65112C6.32692 8.65112 6.23525 8.61446 6.16788 8.54204C6.03817 8.40316 6.0455 8.18546 6.18438 8.05575L6.49192 7.76883H4.23371C4.04396 7.76883 3.88996 7.61483 3.88996 7.42508C3.88996 7.23533 4.04396 7.08133 4.23371 7.08133H6.49238L6.18483 6.79441C6.0455 6.66516 6.03817 6.44746 6.16742 6.30858C6.29713 6.17016 6.51438 6.16191 6.65325 6.29162L7.59925 7
.20519 6.2289 5.99969 6.2289ZM5.99969 8.1029C5.79469 8.1029 5.62819 7.9364 5.62819 7.7309C5.62819 7.5254 5.79469 7.3589 5.99969 7.3589C6.20519 7.3589 6.37169 7.5254 6.37169 7.7309C6.37169 7.9364 6.20519 8.1029 5.99969 8.1029ZM3.8267 6.2289C3.6212 6.2289 3.4547 6.0624 3.4547 5.8569C3.4547 5.6519 3.6212 5.4854 3.8267 5.4854C4.0322 5.4854 4.1987 5.6519 4.1987 5.8569C4.1987 6.0624 4.0322 6.2289 3.8267 6.2289ZM3.8267 8.1029C3.6212 8.1029 3.4547 7.9364 3.4547 7.7309C3.4547 7.5254 3.6212 7.3589 3.8267 7.3589C4.0322 7.3589 4.1987 7.5254 4.1987 7.7309C4.1987 7.9364 4.0322 8.1029 3.8267 8.1029ZM10.0947 2.6649C9.69269 2.2619 9.11969 2.0349 8.43769 1.9779V1.4414C8.43769 1.2114 8.25069 1.0249 8.02069 1.0249C7.79069 1.0249 7.60419 1.2114 7.60419 1.4414V3.4139C7.56769 3.4239 7.53219 3.4364 7.49269 3.4364C7.26219 3.4364 7.07569 3.2494 7.07569 3.0194V2.0534C7.07569 1.99818 7.03094 1.9534 6.97569 1.9534H4.3957V1.4414C4.3957 1.2114 4.2092 1.0249 3.9792 1.0249C3.7487 1.0249 3.5622 1.2114 3.5622 1.4414V3.4139C3.5262 3.4239 3.4902 3.4364 3.4507 3.4364C3.2207 3.4364 3.0337 3.2494 3.0337 3.0194V2.19141C3.0337 2.12638 2.97244 2.07862 2.91008 2.0971C1.84121 2.41381 1.2207 3.27685 1.2207 4.5534V8.3329C1.2207 9.9879 2.2167 10.9754 3.8847 10.9754H8.11519C9.78319 10.9754 10.7792 10.0019 10.7792 8.3709V4.5544C10.7812 3.7694 10.5447 3.1164 10.0947 2.6649Z" fill="#242424"/>
              ...
              <span class="text-[#6D6D6D] font-danaregular">${t.date}</span>
              <span class="text-[#292929] font-danamedium">${visa.visadate?.sstring || '-'}</span>
            </div>
            <div><span class="text-[#6D6D6D] font-danaregular">${t.application}</span> ${visa.application}</div>
            <div><span class="text-[#6D6D6D] font-danaregular">${t.type}</span> ${visa.visatype}</div>
            <div><span class="text-[#6D6D6D] font-danaregular">${t.visit}</span> ${visa.visit_log}</div>
            <div><span class="text-[#6D6D6D] font-danaregular">${t.validity}</span> ${safeValue(visa.validity_duration?.time)} ${safeValue(visa.validity_duration?.months)}</div>
            <div><span class="text-[#6D6D6D] font-danaregular">${t.documents}</span>
    ...
    <div class="w-full">
      <div class="mt-2 rounded-[10px] bg-[#F0F0F0] overflow-hidden border border-[#DADADA]">
        <div class="w-full border-separate border-none">
          ...
          <div class="w-full">
            <div class="w-full flex gap-x-2 ${t.textAlign}">
              ${entries.map(([key]) => {
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M7.12154 6.41675H5.05902C3.91318 6.41675 2.95068 7.37925 2.95068 8.52508V8.66258C2.95068 9.12091 3.31735 9.48758 3.77568 9.48758H8.35904C8.81737 9.48758 9.22987 9.16675 9.18404 8.66258V8.52508C9.22987 7.37925 8.26737 6.41675 7.12154 6.41675Z" fill="#6D6D6D"/>
        ...
        <div class="mb-4 rounded-[10px] bg-[#F8F8F8] relative p-2 overflow-hidden">
          <div class="w-full border-separate border-none">
            <div class="w-full">
              <div class="w-full flex gap-x-2 ${t.textAlign}">
                <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.firstName}</div>
                <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.lastName}</div>
                <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.dateOfBirth}</div>
                <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.nationalCode}</div>
                <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.passportNo}</div>
                <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.passportExpiry}</div>
                <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.issueCountry}</div>
                <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.gender}</div>
                <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.ageType}</div>
                <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.cost}</div>
              </div>
            </div>
            <div class="w-full">
    `;
    ...
    passengers.forEach((pax) => {
      ...
      html += `
        <div class="w-full flex gap-x-2 ${t.textAlign}">
          <div class="text-[#292929] text-xs font-danamedium flex-1">${info.fullname.firstname}</div>
          <div class="text-[#292929] text-xs font-danamedium flex-1">${info.fullname.lastname}</div>
          <div class="text-[#292929] text-xs font-danamedium flex-1">${info.birthdate?.S_birthdate ?? ""}</div>
          <div class="text-[#292929] text-xs font-danamedium flex-1">${info.nationalcode}</div>
          <div class="text-[#292929] text-xs font-danamedium flex-1">${info.passportcode}</div>
          <div class="text-[#292929] text-xs font-danamedium flex-1">${info.passportexpiration}</div>
          <div class="text-[#292929] text-xs font-danamedium flex-1">${info.countryofresidence?.ecountryname ?? info.countryofpassportissue?.ecountryname ?? ""}</div>
          <div class="text-[#292929] text-xs font-danamedium flex-1">${genderMap[info.gender]}</div>
          <div class="text-[#292929] text-xs font-danamedium flex-1">${typeMap[info.type]}</div>
          <div class="text-[#292929] text-xs font-danamedium flex-1">${Number(cost).toLocaleString("en-US")}</div>
        </div>
      `;
        ...
        <div class="mb-4 rounded-[10px] bg-[#F8F8F8] relative p-2 overflow-hidden">
          <div class="w-full border-separate border-none">
            <div class="w-full">
              <div class="w-full flex gap-x-2 ${t.textAlign}">
                <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.firstName}</div>
                <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.surname}</div>
                <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.dateOfBirth}</div>
                <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.nationalCode}</div>
                <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.passportNo}</div>
                <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.passportExpiryDate}</div>
                <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.gender}</div>
                <div class="text-[#6D6D6D] text-xs font-danaregular flex-1">${t.ageRange}</div>
              </div>
            </div>
            <div class="w-full">
    `;
