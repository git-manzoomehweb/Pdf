...
const invoiceTranslations = {
  ...
  2: {
    ...
    // Contract text
    contractText: {
    "template": "This contract is between Mr./Ms. {buyerName} with landline phone number {phone} and mobile number {mobile} residing at {address} individually or as the authorized representative of the following persons by a total of {personCount} persons, hereinafter referred to as \"<span class=\"inline-block font-dana_FANum_demibold mx-1\">Tourist</span>\", on the one hand, and the office {officeName} hereinafter referred to as \"<span class=\"inline-block font-dana_FANum_demibold mx-1\">Operator</span>\", through an <span class=\"inline-block font-dana_FANum_demibold mx-1\">online purchase</span> has been concluded."
    }
  },
  3: {
    // عربی
    ...
    // Contract text
    contractText: {
      "template": "تم إبرام هذا العقد بين السيد/السيدة {buyerName} صاحب رقم الهاتف الأرضي {phone} والجوال {mobile} والمقيم في العنوان {address} بشكل فردي أو كممثل قانوني مفوض عن الأشخاص المذكورين أدناه وعددهم الإجمالي ({personCount} أشخاص، ويُشار إليه فيما بعد بـ\"<span class=\"inline-block font-dana_FANum_demibold mx-1\">السائح</span>\" من جهة، ومكتب {officeName} ويُشار إليه فيما بعد بـ\"<span class=\"inline-block font-dana_FANum_demibold mx-1\">المزود بالخدمة</span>\"، وذلك عن طريق <span class=\"inline-block font-dana_FANum_demibold mx-1\">الشراء الإلكتروني</span>."
    }
  }
};
